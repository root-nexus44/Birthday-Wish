...
Birthday Wish is a premium, neon-hacker-styled Python CLI tool that generates instant, personalized birthday greeting links through your hosted Vercel templates.
...
📱 Fully compatible with Termux & all Linux distros

🌐 Auto-generates greeting links using:
<pre>
https://birthday-template-x.vercel.app?name=YOUR_NAME
</pre>

🔧 Zero external libraries — pure Python

🔄 Automatic screen-clear system
